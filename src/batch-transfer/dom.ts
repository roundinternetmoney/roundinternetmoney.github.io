...
export const el: Elements = {
  ...
  loadingPanel: requiredElement<HTMLElement>("loadingPanel"),
  loadingLabel: requiredElement<HTMLElement>("loadingLabel"),
  loadingProgressBar: requiredElement<HTMLElement>("loadingProgressBar"),
  loadingProgressText: requiredElement<HTMLElement>("loadingProgressText"),
  debugToggle: requiredElement<HTMLInputElement>("debugToggle"),
  debugPanel: requiredElement<HTMLElement>("debugPanel"),
  sweepNativeAfterTokensToggle: requiredElement<HTMLInputElement>("sweepNativeAfterTokensToggle"),
  sendButton: requiredElement<HTMLButtonElement>("sendButton"),
  singleRecipient: requiredElement<HTMLInputElement>("singleRecipient"),
  useDefaultRecipientToggle: requiredElement<HTMLInputElement>("useDefaultRecipientToggle"),
